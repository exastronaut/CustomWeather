...
class CityWeather: UIView {
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            nameCity.centerXAnchor.constraint(equalTo: weatherDescription.centerXAnchor),
            nameCity.bottomAnchor.constraint(equalTo: weatherDescription.topAnchor, constant: -8),

            weatherDescription.centerXAnchor.constraint(equalTo: temperature.centerXAnchor),
            weatherDescription.bottomAnchor.constraint(equalTo: temperature.topAnchor, constant: -8),
